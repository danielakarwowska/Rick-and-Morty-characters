...
const pagination_1 = __importDefault(__webpack_require__(/*! ./components/pagination */ "./src/components/pagination.tsx"));
const App = () => {
    ...
    return (react_1.default.createElement(layout_1.default, null,
        react_1.default.createElement("h1", null, "Characters"),
        react_1.default.createElement(navbar_1.default, { episodes: currentPosts }),
        react_1.default.createElement(pagination_1.default, { nPages: nPages, currentPage: currentPage, setCurrentPage: setCurrentPage })));
};
exports["default"] = App;
...
const PaginationPages = ({ nPages, currentPage, setCurrentPage }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(semantic_ui_react_1.Pagination, { boundaryRange: 0, defaultActivePage: 1, ellipsisItem: null, firstItem: null, lastItem: null, siblingRange: 1, totalPages: 10 }),
        react_1.default.createElement("ul", null, pageNumbers.map((pgNumber) => (react_1.default.createElement("li", { key: pgNumber },
...
const TableBody = ({ episodes, searchInput, selectSpecies }) => {
    ...
    return (react_1.default.createElement(semantic_ui_react_1.Table, { singleLine: true },
        ...
        data.map((episode, index) => react_1.default.createElement(semantic_ui_react_1.Table.Row, { key: index },
